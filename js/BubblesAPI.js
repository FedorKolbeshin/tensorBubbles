/**
 * Created by fReDDy on 14.06.2017.
 */
var bubblesAPI = (function() {
    var
        bubblesAPI={},
        freeCoordinants=[],
        svgArea,
    ...
    bubblesAPI.setFrameWindowParameters = function() {
        var
        ...
        frameDocument = frameWindow.contentWindow.document;
    };

    //функция масштабирования
    bubblesAPI.setZoomAttributes = function(zoomParameter) {
    ...
    //генерируем область
    bubblesAPI.generateBubbleArea = function() {
        prepareBubbleArea();
